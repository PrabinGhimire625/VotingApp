...
export const createCandidate=async(req,res)=>{
    ...
    try{
       const candidateData= await Candidate.create({candidateName, candidateEmail, candidateAddress, candidateDOB,candidateMobileNo,candidateDescription,imageUrl:fileName, userId:userId })
...
export const fetchAllCandidate=async(req,res)=>{
    ...
    res.status(200).json({message:"Successfully fetch all the candidate",data:response})
}
