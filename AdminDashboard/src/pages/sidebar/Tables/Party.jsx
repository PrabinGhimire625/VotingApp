...
const Party = () => {
    ...
    const [searchParty, setSearchParty]=useState("") //for search
    console.log(party)
    ...
    const filterParty=party.filter((part)=>
        part.partyName.toLowerCase().includes(searchParty.toLowerCase()) ||
        part.estd.toLowerCase().includes(searchParty.toLowerCase())
    )
                ...
                <div className="md:w-1/2">
                    <form className="flex items-center">
                        ...
                        <div className="relative w-full">
                            ...
                            <input value={searchParty} onChange={(e)=>setSearchParty(e.target.value)} type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required=""/>
                        </div>
                    </form>
                </div>
